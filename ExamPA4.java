...
public class ExamPA4 extends Application {
    ...
    // Create a combo box for selecting measuring system
    ...
    private Label lblConversion = new Label("Conversion Method");
    ...
    public void start(Stage primaryStage) {   	
        ...
        mainPane.add(lblConversion, 0, 1);
    ...
    private void changeLabels() {
    	...
    	if (cbo.getValue().equals(altResult) && lblCapacity.getText().equals(defaultCapacity)) {
        	// update labels
